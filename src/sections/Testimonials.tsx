                ...
                <div className='flex overflow-hidden mt-10 [mask-image:linear-gradient(to_right,transparent,black_20%,black_80%,transparent)]'>
                    ...
                    >
                        {[...testimonials, ...testimonials].map((testimonial, index) => (
                            <div
                                key={index}
                                className='border border-white/15 p-4 md:p-10 rounded-lg bg-[linear-gradient(to_bottom_left,rgb(140,69,255,.3),black)] max-w-[200px] md:max-w-md flex-none text-center md:text-left'
                            >
                                <div className='text-sm md:text-xl tracking-tight'>{testimonial.text}</div>
